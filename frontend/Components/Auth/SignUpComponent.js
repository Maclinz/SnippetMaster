...
const passwordIcon =  <i class="fi fi-rr-lock"></i>;
            ...
            <form action="" onSubmit={handleSubmit}>
               <div className="form-content">
                ...
                <div className="input-control">
                        ...
                        <input value={name} onChange={handleChange('name')} type="text" placeholder='Enter Name' />
                    </div>
                    <div className="input-control">
                        <label htmlFor="email">Email</label>
                        <input value={email} onChange={handleChange('email')} type="email" placeholder='Enter Your Email' />
                    </div>
                    <div className="input-control ">
                        <label className='password' htmlFor="password">Password <span>{passwordIcon}</span></label>
                        <input value={password} onChange={handleChange('password')} type="password" placeholder='Enter Your Password' />
                    </div>
                    <div className="form-btn">
                        <button className="btn-submit">{btn}</button>
                    </div>
